...
function LeafCheck() {
  return (
    ...
    >
      ...
      {/* Leaf cluster */}
      <ellipse cx="40" cy="36" rx="10" ry="5" fill="#A8C97F" opacity="0.6"
        transform="rotate(-30 40 36)" />
      <ellipse cx="44" cy="42" rx="9" ry="4.5" fill="#5B8A3C" opacity="0.5"
        transform="rotate(15 44 42)" />
      <ellipse cx="35" cy="42" rx="8" ry="4" fill="#A8C97F" opacity="0.45"
        transform="rotate(-50 35 42)" />
      {/* Check mark */}
      <path
...
export default function CompletePage() {
  ...
  return (
    ...
    >
      ...
      >
        Your add-ons have been reserved and will be ready on arrival.
      </p>
      <p
            ...
            {confirmedItems.map((item) => (
              <div
                ...
                style={{
                  ...
                  borderLeft: '3px solid #5B8A3C',
                  borderRadius: 8,
                }}
              >
                <span className="text-sm font-medium truncate" style={{ color: '#2C4A1E' }}>
                  {item.title}
                </span>
                <span className="text-sm font-semibold shrink-0" style={{ color: '#5B8A3C' }}>
